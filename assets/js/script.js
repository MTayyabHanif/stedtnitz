...
jQuery(document).ready(function() {
    ...
    jQuery('.closesearch').click(function() {
        jQuery('.searchoverlay').fadeOut(250);
    });
	...
	*/
    ...
    // 		explore_block.css({"transform": "translate3d(0px, 0px, 0px)", "opacity": "1"});

    // 		setTimeout(function(){ 
    // 			social.css({"transform": "translate3d(0px, 0px, 0px)", "opacity": "1"});
    // 		}, 200);
    ...
    // 		explore_block.css({"transform": "translate3d(0px, 30px, 0px)", "opacity": "0"});
    // 		social.css({"transform": "translate3d(0px, 20px, 0px)", "opacity": "0"});
    // 	}
